...
// Use crate imports instead of mod declarations
use ralph_autonomous_agent::config::RalphConfig;
use ralph_autonomous_agent::error::Result;
use std::env;
...
#[cfg(test)]
mod tests {
    // Use crate imports instead of super
    use ralph_autonomous_agent::agents::{RalphLoopAgent, RalphWorkerAgent};
    use adk_core::Agent;
