...
pub enum RealtimeError {
    ...
    /// Signal to the Runner that the underlying protocol cannot hot-swap
    /// parameters and requires a Phantom Reconnect.
    #[error("Provider requires a soft reconnect for context mutation")]
