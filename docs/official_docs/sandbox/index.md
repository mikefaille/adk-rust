...
adk-sandbox = { version = "0.8.0", features = ["process", "sandbox-native"] }

# Or pick a specific platform
adk-sandbox = { version = "0.8.0", features = ["process", "sandbox-macos"] }
adk-sandbox = { version = "0.8.0", features = ["process", "sandbox-linux"] }
```
