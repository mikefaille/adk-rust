...
pub fn content_to_message(content: &Content) -> IndexMap<String, Value> {
    ...
    let role = match &content.role {
        adk_core::prelude::Role::User => "user".to_string(),
        adk_core::prelude::Role::Model => "assistant".to_string(),
        adk_core::prelude::Role::System => "system".to_string(),
        adk_core::prelude::Role::Tool => "tool".to_string(),
        adk_core::prelude::Role::Custom(c) => c.clone(), // Pass through unknown roles
    };
