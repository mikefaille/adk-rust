...
pub async fn assert_session_contract_with_users(
    ...
    let sessions_user1 = service
        .list(ListRequest { app_name: app_name.to_string(), user_id: UserId::new( user_1.to_string()) })
        .await
    ...
    let user2 = service
        .create(CreateRequest {
            app_name: app_name.to_string(),
            user_id: UserId::new( user_2.to_string()),
            session_id: SessionId::new( None,
            state: HashMap::new(),
        })
        .await
    ...
    let sessions_user2 = service
        .list(ListRequest { app_name: app_name.to_string(), user_id: UserId::new( user_2.to_string()) })
        .await
    ...
    let sessions_other_app = service
        .list(ListRequest { app_name: other_app_name.to_string(), user_id: UserId::new( user_1.to_string()) })
        .await
    ...
    service
        .delete(DeleteRequest {
            app_name: app_name.to_string(),
            user_id: UserId::new( user_2.to_string()),
            session_id: SessionId::new( user2_session_id,
        })
        .await
    ...
    service
        .delete(DeleteRequest {
            app_name: other_app_name.to_string(),
            user_id: UserId::new( user_1.to_string()),
            session_id: SessionId::new( other_app_session_id,
        })
        .await
