...
pub async fn assert_session_contract_with_users(
    ...
    let created = service
        .create(CreateRequest {
            ...
            user_id: adk_core::types::UserId::new(user_1.to_string()).unwrap(),
            session_id: None,
            state: initial_state,
        })
        .await
    ...
    let sessions_user1 = service
        .list(ListRequest { app_name: app_name.to_string(), user_id: adk_core::types::UserId::new(user_1.to_string()).unwrap() })
        .await
    ...
    let user2 = service
        .create(CreateRequest {
            app_name: app_name.to_string(),
            user_id: adk_core::types::UserId::new(user_2.to_string()).unwrap(),
            session_id: None,
            state: HashMap::new(),
        })
        .await
    ...
    let sessions_user2 = service
        .list(ListRequest { app_name: app_name.to_string(), user_id: adk_core::types::UserId::new(user_2.to_string()).unwrap() })
        .await
    ...
    let sessions_other_app = service
        .list(ListRequest { app_name: other_app_name.to_string(), user_id: adk_core::types::UserId::new(user_1.to_string()).unwrap() })
        .await
