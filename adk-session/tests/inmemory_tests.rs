...
async fn test_create_session() {
    ...
    let req = CreateRequest {
        ...
        user_id: adk_core::types::UserId::new("user1").unwrap(),
        session_id: Some(adk_core::types::SessionId::new("session1").unwrap()),
        state: HashMap::new(),
    };
...
async fn test_get_session() {
    ...
    let session = service
        .get(GetRequest {
            app_name: "test_app".to_string(),
            user_id: adk_core::types::UserId::new("user1").unwrap(),
            session_id: adk_core::types::SessionId::new("session1").unwrap(),
...
async fn test_append_event() {
    ...
    service.append_event(&adk_core::types::SessionId::new("session1").unwrap(), event).await.unwrap();
...
async fn test_list_sessions() {
    ...
    service
        .create(CreateRequest {
            app_name: "test_app".to_string(),
            user_id: adk_core::types::UserId::new("user1").unwrap(),
            session_id: Some(adk_core::types::SessionId::new("session2").unwrap()),
            state: HashMap::new(),
        })
        .await
        .unwrap();
    ...
    let sessions = service
        .list(ListRequest { app_name: "test_app".to_string(), user_id: adk_core::types::UserId::new("user1").unwrap() })
        .await
        .unwrap();
