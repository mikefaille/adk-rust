...
pub mod prelude {
    ...
    // Browser
    #[cfg(feature = "browser")]
    pub use crate::browser::{BrowserSession, BrowserConfig, BrowserToolset};

    // Eval
    #[cfg(feature = "eval")]
    pub use crate::eval::{Evaluator, EvaluationConfig, EvaluationCriteria};

    // Guardrail
    #[cfg(feature = "guardrail")]
    pub use crate::guardrail::{GuardrailSet, ContentFilter, PiiRedactor};

    // Auth
    #[cfg(feature = "auth")]
    pub use crate::auth::{Permission, Role, AccessControl};
