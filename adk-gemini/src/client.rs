...
pub enum Error {
    ...
    #[snafu(display("operation '{operation}' failed: Vertex AI support is disabled (enable 'vertex' feature)"))]
    GoogleCloudUnsupported {
        operation: &'static str,
    },
...
#[cfg(test)]
mod client_tests {
    use super::{Error, GeminiClient};
    #[cfg(feature = "vertex")]
    use super::extract_service_account_project_id;
