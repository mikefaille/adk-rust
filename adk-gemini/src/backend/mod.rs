...
use crate::{
    ...
    cache::model::{CachedContent, CachedContentSummary, CreateCachedContentRequest, ListCachedContentsResponse, CacheExpirationRequest, CacheExpirationResponse},
    embedding::model::{
...
pub trait GeminiBackend: Send + Sync + std::fmt::Debug {
    ...
    /// Upload a file
    async fn upload_file(&self, _display_name: Option<String>, _bytes: Vec<u8>, _mime_type: String) -> Result<File, Error> {
