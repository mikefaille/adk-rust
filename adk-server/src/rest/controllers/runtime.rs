    ...
    async move {
        ...
        controller
            ...
            .get(adk_session::GetRequest {
                ...
                session_id: adk_core::types::SessionId::new(session_id.clone()).expect("valid"),
        ...
        let event_stream = runner
            .run(adk_core::types::UserId::new(user_id).expect("valid user id"), adk_core::types::SessionId::new(session_id).expect("valid session id"), content)
            .await
    ...
    if session_result.is_err() {
        controller
            ...
            .create(adk_session::CreateRequest {
                app_name: app_name.clone(),
                user_id: adk_core::types::UserId::new(user_id.clone()).expect("valid"),
                session_id: Some(adk_core::types::SessionId::new(session_id.clone()).expect("valid")),
